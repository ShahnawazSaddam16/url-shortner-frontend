        ...
        <div className="rounded-3xl bg-linear-to-br from-white to-purple-50 border border-purple-100 shadow-[0_30px_60px_rgba(168,85,247,0.06)] p-6">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className={`h-12 px-5 rounded-2xl text-white font-semibold shadow-md transition-all duration-200 flex items-center justify-center gap-2 ${
                loading
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            >
              ...
              <div className="text-xs mt-1">Protect with password</div>
            </button>
            ...
            >
              ...
              <div className="text-xs mt-1">Set expiration</div>
            </button>
            ...
            >
              ...
              <div className="text-xs mt-1">Generate QR code</div>
            </button>
          </div>
